...
-- 샘플 사용자
INSERT INTO member (name, email, password, role) VALUES ('관리자', 'admin@example.com', 'password', 'ADMIN');
INSERT INTO member (name, email, password, role) VALUES ('홍길동', 'hong@example.com', 'password', 'USER');
INSERT INTO member (name, email, password, role) VALUES ('김철수', 'kim@example.com', 'password', 'USER');
INSERT INTO member (name, email, password, role) VALUES ('이영희', 'lee@example.com', 'password', 'USER');
