...
INSERT INTO member (name, email, password) VALUES ('이영희', 'lee@example.com', 'password');
INSERT INTO member (name, email, password) VALUES ('박민준', 'park@example.com', 'password');
INSERT INTO member (name, email, password) VALUES ('최지우', 'choi@example.com', 'password');
...
INSERT INTO reservation (member_id, date, time_id, theme_id) VALUES (2, DATEADD('DAY', 1, CURRENT_DATE), 3, 2);
INSERT INTO reservation (member_id, date, time_id, theme_id) VALUES (3, DATEADD('DAY', 2, CURRENT_DATE), 2, 3);
INSERT INTO reservation (member_id, date, time_id, theme_id) VALUES (4, DATEADD('DAY', 3, CURRENT_DATE), 5, 4);
INSERT INTO reservation (member_id, date, time_id, theme_id) VALUES (5, DATEADD('DAY', 1, CURRENT_DATE), 4, 1);
